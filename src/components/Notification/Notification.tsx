...
const Notification = () => {
  ...
  return (
    <>
      <button
        ref={bellButtonRef}
        className='w-8 h-8 rounded bg-white/20 hover:bg-white/30 flex items-center justify-center text-white duration-300'
      ...
      {isNotificationOpen && (
        <div
          ref={notificationRef}
          className='fixed z-[999] min-h-[300px] max-h-[calc(100vh_-_100px)] w-96 bg-white border border-gray-200 backdrop-blur-md top-12 right-6 rounded shadow-lg overflow-y-auto'
        >
